...
The `aixdeb` command can step through a Aixcoin Script and show stack content and operations on a per op level.
```
aixdeb> help
...
```Bash
$ aixdeb '[OP_DUP OP_HASH160 897c81ac37ae36f7bc5b91356cfb0138bfacb3c1 OP_EQUALVERIFY OP_CHECKSIG]' 3045022100c7d8e302908fdc601b125c2734de63ed3bf54353e13a835313c2a2aa5e8f21810220131fad73787989d7fbbdbbd8420674f56bdf61fed5dc2653c826a4789c68501101 03b05bdbdf395e495a61add92442071e32703518b8fca3fc34149db4b56c93be42
valid script
...
Alternatively, you can pass both the transaction (using `--tx=`) and the input transaction (using `--txin=`). In this case, if you do not provide any other parameters (script/stack data), `aixdeb` will automatically figure out the script and stack content for verifying the input specified by the `txin` hex. You also do not need to include the amounts when passing the `txin` explicitly.

```Bash
$ aixdeb --tx= \
...
aixdeb has a built-in toolkit for transforming values. To see all currently available transform operations type `tf -h`.

If you compile with the `--enable-dangerous` flag set, you can also manipulate private keys. E.g.

```Bash
aixdeb> tf sha256 alice
2bd806c97f0e00af1a1fc3328fa763a9269723c8db8fac4f93af71db186d6e90
aixdeb> tf get-xpubkey 2bd806c97f0e00af1a1fc3328fa763a9269723c8db8fac4f93af71db186d6e90
9997a497d964fc1a62885b05a51166a65a90df00492c8d7cf61d6accf54803be
aixdeb> tf sha256 message
ab530a13e45914982b79f9b7e3fba994cfd1f3fb22f71cea1afbf02b460c6d1d
aixdeb> tf sign ab530a13e45914982b79f9b7e3fba994cfd1f3fb22f71cea1afbf02b460c6d1d 2bd806c97f0e00af1a1fc3328fa763a9269723c8db8fac4f93af71db186d6e90
...
aixdeb> tf verify-sig ab530a13e45914982b79f9b7e3fba994cfd1f3fb22f71cea1afbf02b460c6d1d 9997a497d964fc1a62885b05a51166a65a90df00492c8d7cf61d6accf54803be bd910c7f1340c525384c739bbde410e7d37701fdfacbec0a0d6d1d360381a4c01e85aee61eb30de834f111630b6c47803e0f17bf6397573f28508168531019ec
1
```
...
```Bash
aixdeb> tf get-xpubkey sha256(alice)
9997a497d964fc1a62885b05a51166a65a90df00492c8d7cf61d6accf54803be
aixdeb> tf sign sha256(message) sha256(alice)
bd910c7f1340c525384c739bbde410e7d37701fdfacbec0a0d6d1d360381a4c01e85aee61eb30de834f111630b6c47803e0f17bf6397573f28508168531019ec
